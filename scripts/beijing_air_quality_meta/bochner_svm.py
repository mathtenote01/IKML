...
def main(
    ...
    traindata = AirQualityDataLoader(k_support, k_query, split="train", t=True)
    valdata = AirQualityDataLoader(k_support, k_query, split="valid", t=True)
    testdata = AirQualityDataLoader(k_support, k_query, split="test", t=True)
