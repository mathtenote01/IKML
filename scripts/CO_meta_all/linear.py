...
def main(
    ...
    for iteration in range(num_iterations):
        ...
        def _fast_adapt_ker_valid(batch, model, device):
        ...
        if validate:
            ...
            with futures.ThreadPoolExecutor() as executor:
                ...
                for val_batch in val_batches:
                    executor.submit(_fast_adapt_ker_valid, val_batch, tmp, device)
            # for val_batch in val_batches:
            #     evaluation_error = fast_adapt_ker(
            #         batch=val_batch,
            #         model=model,
            ...
            print("lambda: {}".format(torch.exp(model.log_lam).item()))
