...
# California_covid19_meta:bochner_ikml
# 'meta_lr': 0.1161544753183619, 'lam': 0.34530700798835245, 'latent_d': 6, 'hidden_dim': 20, 'num_layers': 1
    # meta_lr = 0.116
    # lam = 0.3453
    # latent_d = 6
    # hidden_dim = 20
    ...
    # traindata_meta = Covid_19economic_DataLoader(k_support, k_query, split="train")
    # valdata_meta = Covid_19economic_DataLoader(k_support, k_query, split="valid")
    # testdata_meta = Covid_19economic_DataLoader(k_support, k_query, split="test")
    # traindata = PM25Coal_Fired_Power_PlantsDataLoader(k_support, k_query, split="train")
    # valdata = PM25Coal_Fired_Power_PlantsDataLoader(k_support, k_query, split="valid")
    # testdata = PM25Coal_Fired_Power_PlantsDataLoader(k_support, k_query, split="test")
    ...
    # traindata_[4] = AirQualityDataLoader(k_support, k_query, split="train")
    ...
    def objective(trial):
        ...
        testdata_meta = Covid_19economic_DataLoader(k_support, k_query, split="test")
        traindata = PM25Coal_Fired_Power_PlantsDataLoader(k_support, k_query, split="train")
        valdata = PM25Coal_Fired_Power_PlantsDataLoader(k_support, k_query, split="test")
        testdata = PM25Coal_Fired_Power_PlantsDataLoader(k_support, k_query, split="test")
